...
public class WednesdayFragment extends SherlockFragment {
	private static ListView wList;
	...
	public View onCreateView(LayoutInflater inf, ViewGroup grp, Bundle icicle) {
		View v = inf.inflate(R.layout.timetable_wednesday_fragment, grp, false);
		wList = (ListView) v.findViewById(R.id.wednesday); 
	...
	private void update() {
	datax.open();
	results = datax.selectAllFromDay(2);
	datax.close();
    ...
    wList.setAdapter(simpleAdapter); 
    simpleAdapter.notifyDataSetChanged();
}

...
public class ThursdayFragment extends SherlockFragment {
	private static ListView thList;
	...
	public View onCreateView(LayoutInflater inf, ViewGroup grp, Bundle icicle) {
		View v = inf.inflate(R.layout.timetable_thursday_fragment, grp, false);
		thList = (ListView) v.findViewById(R.id.thursday); 
	...
	private void update() {
	datax.open();
	results = datax.selectAllFromDay(3);
	datax.close();
    ...
    thList.setAdapter(simpleAdapter); 
    simpleAdapter.notifyDataSetChanged();
}
